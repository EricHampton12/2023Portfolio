      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-8 lg:flex-row lg:items-center lg:gap-x-12">
          ...
          <div className="flex-1 text-center font-secondary lg:text-left">
            ...
            >
              <a href="https://www.linkedin.com/in/james-hampton-102107191/">
                <FaLinkedin />
              </a>
              <a href="https://github.com/EricHampton12">
                <FaGithub />
              </a>
              <a href="https://www.instagram.com/erichamptonlifts/?hl=en">
                <FaInstagram />
              </a>
            </motion.div>
          </div>
