      ...
      <div className="container mx-auto">
        <div className="flex flex-col gap-y-10 lg:flex-row lg:items-center lg:gap-x-20 lg:gap-y-0 h-screen ${window.innerWidth < 640 ? 'rounded-none' : 'rounded-full'} overflow-hidden`}" >
          ...
          <motion.div
            ...
            className="flex-1 bg-about rounded-full bg-contain bg-no-repeat h-[640px] mix-blend-lighten bg-top"
          ></motion.div>
          {/* text */}
          <motion.div
          ...
          >
            ...
            <p className="mb-6">
              I have experience with HTML, CSS, JavaScript, React, Tailwind CSS,
              SCSS and many more.
            </p>
            {/* stats */}
            ...
            <div className="flex gap-x-8 items-center">
              ...
              <a
                href="https://github.com/EricHampton12"
